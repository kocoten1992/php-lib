...
class StrUtil {
    ...
    static public function replaceOnce(Array $searches, Array $replacements, String $str)
    {
        ////////////////////////////////////////////////////////
        // STRATEGY
        ////////////////////////////////////////////////////////
        ...
        for ($i = 0; $i < $pair_count; $i++) {
            ...
            if ($i === 0) {
                ...
                $k_character_set = array_unique(str_split($searches[$i]));
    ...
    static protected function multiStrpos(String $haystack, String $needle)
    {
    ...
    static protected function replaceAtIndex(
        String $search,
        String $replace,
        String $str,
        Int $index
    ...
    static protected function updateReplaceMap(
        Array $replace_map,
        Array $searches,
        Array $replacements,
        String $search,
